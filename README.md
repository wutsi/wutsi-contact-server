[![](https://github.com/wutsi/wutsi-contact-server/actions/workflows/master.yml/badge.svg)](https://github.com/wutsi/wutsi-contact-server/actions/workflows/master.yml)
...
- Create a database named `wutsi-contact`
...
- Install
```
$ git clone git@github.com:wutsi/wutsi-contact-server.git
```

- Build
```
$ cd wutsi-contact-server
$ mvn clean install
```
...
# Links
- [API](https://wutsi.github.io/wutsi-contact-server/api/)
- [Documentation](docs/)
